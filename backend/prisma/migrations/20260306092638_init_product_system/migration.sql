...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('NEW_ORDER', 'PROCESSING', 'SHIPPED', 'DELIVERED');
...
-- CreateIndex
CREATE INDEX "order_items_merchantId_idx" ON "order_items"("merchantId");
...
-- AddForeignKey
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_merchantId_fkey" FOREIGN KEY ("merchantId") REFERENCES "merchants"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
