      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1">
          <Link href="/" className="mb-6 block">
            <span className="text-3xl font-black tracking-tighter text-white italic">Arohoo</span>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 text-sm">
            <li><Link href="/merchant/signup" className="hover:text-white transition-colors">Become a Merchant</Link></li>
            <li><Link href="/malls" className="hover:text-white transition-colors">Search Malls</Link></li>
